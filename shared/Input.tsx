  ...
  (
    ...
    return (
      <input
        ref={ref}
        type={type}
        // `data-slot="control"` is the hook Catalyst's `Field` (shared/fieldset)
        // uses to space a control against its label and description. PickLT's
        // Input predates being used inside a Fieldset and did not carry it, so
        // label/input spacing silently collapsed.
        data-slot="control"
